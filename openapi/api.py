...
def return_results(list_of_dicts, query, threshold):
    ...
    for index, item in enumerate(list_of_dicts):
        ...
        partial_ratios = [fuzz.partial_ratio(str(query), str(value)) for value in values] # ensure both are in string
        ratios = [fuzz.ratio(str(query), str(value)) for value in values]
